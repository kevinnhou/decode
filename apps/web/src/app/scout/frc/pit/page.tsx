          ...
          const result = await submitPit({
            ...
            intakeMethods:
              values.intakeMethods && values.intakeMethods.length > 0
                ...
                : undefined,
            canPassTrench: values.canPassTrench,
            canCrossBump: values.canCrossBump,
  ...
  const checkSectionCompletion = useCallback(
    async (sectionIndex: number): Promise<boolean> => {
      switch (sectionIndex) {
        ...
        case 2: {
          return !!(
            form.getValues("hopperCapacity") ||
            form.getValues("shootingSpeed") ||
        ...
        case 3: {
          return (
            form.getValues("canPassTrench") || form.getValues("canCrossBump")
          );
        }
        case 4: {
          return !!(
